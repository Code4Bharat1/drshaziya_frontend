...
//           <div className="absolute inset-0 top-4 bg-[#FFB900] rounded-3xl transform rotate-[-12deg] -translate-x-6 z-0 shadow-[0_3px_2px_rgba(0,0,0,0.2)]"></div>

//           {/* White main card */}
//           <div className="relative z-10 bg-white rounded-3xl  p-6 sm:p-8 text-gray-800">
//             {/* Top-left quote icon */}
//             <div className="absolute -top-5 left-6 sm:left-9 bg-[#069bd6] p-3 sm:p-4 rounded-full shadow-md">
//               <FaQuoteLeft className="text-white text-lg sm:text-xl" />
//             </div>

          
//             {/* Bottom-right quote icon */}
//             <div className="absolute -bottom-5 right-6 sm:right-9 bg-[#069bd6] p-3 sm:p-4 rounded-full shadow-md">
...
//     className="bg-[#069bd6] hover:bg-[#006fb6] text-white font-medium px-9 py-3 rounded-2xl shadow-md transition duration-300 mb-4"
//   >
//     VIEW GOOGLE REVIEW
//   </a>
...
const Testimonial = () => {
  ...
  <script type="application/ld+json">
    ...
    <div className="bg-[#F8F9FE] px-4 pt-10 sm:pt-8">
      {/* Heading */}
      <h2 className="text-2xl sm:text-3xl font-semibold text-[#284578] text-center mt-24 ">
        TESTIMONIAL
      </h2>
      ...
      <div className="flex justify-center mt-16 mb-0">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="bg-[#069bd6] hover:bg-[#006fb6] text-white font-medium px-9 py-3 rounded-md  transition duration-300 mb-6 shadow-[0_3px_5px_rgba(0,0,0,0.4)]"
        >
          VIEW GOOGLE REVIEW
        </a>
      </div>
