...
{/* main code start from here */}
    <div className="bg-[#F8F9FE] px-4 pt-10 sm:pt-8">
      {/* Heading */}
      <h2 className="text-3xl  font-semibold text-[#284578] text-center mt-20 ">
        TESTIMONIALS
      </h2>
      ...
      <div className="flex justify-center items-start mt-11">
        ...
        >
          ...
          <div className=" ml-8 absolute inset-0  bg-[#FFB900] rounded-3xl transform rotate-[-11deg] -translate-x-6 z-0 shadow-[0_3px_2px_rgba(0,0,0,0.2)]"></div>
