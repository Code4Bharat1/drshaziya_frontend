  ...
  return (
    ...
    `}
      ...
      <div className="bg-[#F8F9FE] px-4 pt-10 sm:pt-8">
        ...
        {/* Carousel Section */}
        <div className="flex flex-col lg:flex-row items-start gap-8 mb-12 px-2 sm:px-4">
          ...
          <div className="flex-shrink-0 w-full lg:w-auto">
            ...
            <div className="mb-6 flex justify-center lg:justify-start">
              <img
                src="/quoteicon.png"
                alt="Quote Icon"
                className="w-32 h-32 sm:w-56 sm:h-72 lg:w-64 lg:h-80 object-contain"
              />
            </div>
          ...
          <div className="flex-1 w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {/* Mobile view - show current card only */}
              <div className="lg:hidden">
                {testimonials.slice(carouselIndex, carouselIndex + 1).map((testimonial, index) => (
                  <div
                    key={index}
