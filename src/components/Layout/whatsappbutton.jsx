...
//     window.open('https://wa.me/919833584847', '_blank');
//   };

//   const handlePhoneClick = () => {
//     window.location.href = 'tel:+919833584847';
//   };

//   return (
//     <div className="fixed bottom-6 right-6 z-50">
//       <div 
//         className="relative flex flex-col items-end space-y-3"
...
//             className="bg-white text-blue-700 p-3 rounded-full shadow-lg transition-all duration-300 cursor-pointer transform hover:scale-110 border-blue-700"
//           >
