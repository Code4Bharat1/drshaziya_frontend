...
const MissionVission = () => {
  return (
    <div className="bg-[#f8f8fc] w-full px-4 py-10 font-sans">
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row justify-between items-start border-b py-10 gap-10 md:gap-0">
        
        {/* Vision */}
        <div className="md:w-1/2 md:pr-8 border-r md:border-r-black">
