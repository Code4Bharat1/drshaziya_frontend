    ...
    <div className="bg-[#F8F9FE] text-[#000] p-6">
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-start gap-9 lg:ml-24 ">
        ...
        <div className="w-full lg:w-2/3 ml-16">
          ...
          <button className=" font-semibold text-md bg-[#0085DC] hover:bg-blue-500 text-white px-6 py-3 rounded-md transition duration-200 mt-7 mb-7"  onClick={() => router.push('/contactus')}>
            BOOK AN APPOINTMENT
          </button>
        </div>
      </div>
