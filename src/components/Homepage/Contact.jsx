  ...
  return (
    <>
      ...
      <div className="bg-gray-50 py-6 px-4 flex items-center justify-center">
        <div className="bg-[#284578] text-white rounded-xl border-4 border-[#FFB900] p-8 flex flex-col md:flex-row items-center justify-between max-w-5xl mx-auto mt-2 mb-9 shadow-[0_4px_2px_rgba(0,0,0,0.2)]">
