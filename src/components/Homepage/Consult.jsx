...
//       <h2 className="text-2xl md:text-[38px] mx-8 md:mx-0 font-semibold text-center text-[#004979] mb-12">
...
//           <div
//             key={index}
//             className="bg-white border rounded-xl  shadow-[0_3px_4px_-1px_rgba(0,0,0,0.5)] md:shadow p-4 w-full max-w-[280px] md:max-w-[350px] md:min-h-[280px] flex flex-col transform transition duration-300 hover:scale-105 hover:shadow-lg"
//           >
//             <h3 className="text-[15px]  md:text-lg font-semibold text-[#000000] mb-4 whitespace-pre-wrap">
//               {card.title}
//             </h3>
//             <p className="text-[15px] md:text-md  text-[#000000] leading-relaxed flex-grow font-roboto">
//               {card.description}
//             </p>
//           </div>
//         ))}
    ...
    <div className="bg-[#F8F9FE] py-3 sm:py-12 px-2 sm:px-8 md:px-12 lg:px-20 xl:px-32">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 place-items-center">
        {cardData.map((card, index) => (
          ...
          >
            <h3 className="text-[15px] md:text-lg font-semibold text-[#000000] mb-3 whitespace-pre-wrap">
              {card.title}
            </h3>
            <p className="text-[14px] md:text-md text-[#000000] leading-relaxed flex-grow font-roboto">
              {card.description}
            </p>
          </div>
        ))}
